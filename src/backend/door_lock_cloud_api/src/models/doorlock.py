...
class DoorLock():
    ...
    """
    def __init__(self, device_id: int, site_id: str, door_state: DoorState, lock_state: LockState, name = "No Name"):
    ...
    def to_json(self) -> Dict:
        return {definitions.DOOR_STATE: self.door_state.name, definitions.LOCK_STATE: self.lock_state.name, definitions.DEVICEID : self.device_id, definitions.NAME : self.name}

    def states_to_json(self) -> Dict:
        return {definitions.DOOR_STATE: self.door_state.name, definitions.LOCK_STATE: self.lock_state.name, definitions.NAME : self.name}
    ...
    def from_json(json: Dict, siteId: str, deviceId: str):
        ...
        try:
            ...
            name = json[definitions.NAME]
            return DoorLock(device_id, site_id, door_state, lock_state, name)   
